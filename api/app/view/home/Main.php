			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						...
						<p>Aque estão alguns dos melhores planos que eu ofereço</p>
					</div>
					<!-- Section title end -->
				</div>
			</div>
				...
				<div class="col-md-4">
					...
					<div class="pricing-single wow fadeInUp" data-wow-delay="0.3s">
						<div class="pricing-header">
							...
							<h3>Básico Site Institucional</h3>
				...
				<div class="col-md-4">
					...
					<div class="pricing-single wow fadeInUp" data-wow-delay="0.6s">
						<div class="pricing-header">
							...
							<h3>Essencial Site Institucional</h3>
				...
				<div class="col-md-4">
					...
					<div class="pricing-single wow fadeInUp" data-wow-delay="0.9s">
						<div class="pricing-header">
							...
							<h3>Completo Site Institucional</h3>
